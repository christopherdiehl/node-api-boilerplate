...
- [Joi](#joi)
  ...
  - [`object`](#object)
    - [`object.keys([schema])`](#objectkeysschema)
      - [`***REMOVED******REMOVED*** notation`](#-notation)
...
- `options` - an optional object with the following optional keys:
  ...
  - `language` - overrides individual error messages, when `'label'` is set, it overrides the key name in the error message. Defaults to no override (`***REMOVED******REMOVED***`).
...
Joi.validate(value, schema, function (err, value) ***REMOVED*** ***REMOVED***);
// err -> null
...
// result.error -> null
// result.value -> ***REMOVED*** "a" : 123 ***REMOVED***
```
...
```javascript
var definition = ['key', 5, ***REMOVED*** a: true, b: [/^a/, 'boom'] ***REMOVED***];
...
```javascript
var any = Joi.any();
any.validate('a', function (err, value) ***REMOVED*** ***REMOVED***);
```
...
schema.validate(***REMOVED*** username: 'test', password: 'hunter2' ***REMOVED***, function (err, value) ***REMOVED***
    // value = ***REMOVED*** username: 'test' ***REMOVED***
***REMOVED***);

var schema = Joi.array().items(Joi.string(), Joi.any().strip());

schema.validate(['one', 'two', true, false, 1, 2], function (err, value) ***REMOVED***
    // value = ['one', 'two']
***REMOVED***);
```
...
```javascript
var schema = Joi.any().meta(***REMOVED*** index: true ***REMOVED***);
```
...
```javascript
var schema = Joi.any().options(***REMOVED*** convert: false ***REMOVED***);
```
...
```javascript
var generateUsername = function (context) ***REMOVED***
...
Joi.validate(***REMOVED***
    firstname: 'Jane',
    lastname: 'Doe'
***REMOVED***, schema, function (err, value) ***REMOVED***
...
```javascript
var schema = ***REMOVED***
    a: Joi.any().valid('x').when('b', ***REMOVED*** is: 5, then: Joi.valid('y'), otherwise: Joi.valid('z') ***REMOVED***),
    b: Joi.any()
***REMOVED***;
```
...
var schema = ***REMOVED***
    ...
    other: Joi.string()
        .when('a', ***REMOVED*** is: 'other', then: Joi.required() ***REMOVED***),
***REMOVED***;
```
...
schema.validate(''); // returns ***REMOVED*** error: null, value: undefined ***REMOVED***
schema = schema.empty();
schema.validate(''); // returns ***REMOVED*** error: "value" is not allowed to be empty, value: '' ***REMOVED***
```
...
array.validate(['a', 'b', 'a'], function (err, value) ***REMOVED*** ***REMOVED***);
```
...
schema.validate([4]); // returns `***REMOVED*** error: null, value: [ 4 ] ***REMOVED***`
schema.validate(4); // returns `***REMOVED*** error: null, value: [ 4 ] ***REMOVED***`
```
...
boolean.validate(true, function (err, value) ***REMOVED*** ***REMOVED***);
```
...
```javascript
var date = Joi.date();
date.validate('12-21-2012', function (err, value) ***REMOVED*** ***REMOVED***);
```
...
```javascript
var func = Joi.func();
func.validate(function () ***REMOVED******REMOVED***, function (err, value) ***REMOVED*** ***REMOVED***);
```
...
number.validate(5, function (err, value) ***REMOVED*** ***REMOVED***);
```
...
```javascript
var object = Joi.object().keys(***REMOVED***
    a: Joi.number().min(1).max(10).integer(),
    b: 'some string'
***REMOVED***);

object.validate(***REMOVED*** a: 5 ***REMOVED***, function (err, value) ***REMOVED*** ***REMOVED***);
```

#### `object.keys([schema])`

Sets or extends the allowed object keys where:
- `schema` - optional object where each key is assigned a **joi** type object. If `schema` is `***REMOVED******REMOVED***` no keys allowed.
...
```javascript
var base = Joi.object().keys(***REMOVED***
    a: Joi.number(),
    b: Joi.string()
***REMOVED***);
// Validate keys a, b and c.
var extended = base.keys(***REMOVED***
    c: Joi.boolean()
***REMOVED***);
```
...
```javascript
var schema = Joi.object().keys(***REMOVED***
    a: Joi.string(),
    b: Joi.number()
***REMOVED***);
```
...
##### `***REMOVED******REMOVED*** notation`

When using the `***REMOVED******REMOVED***` notation, you are just defining a plain JS object, which isn't a schema object.
...
Besides, passing the `***REMOVED******REMOVED***` object to the `validate()` method each time, will perform an expensive schema compilation operation on every validation.
...
schema.validate(true, function (err, value) ***REMOVED***
    console.log('err: ', err);
***REMOVED***);
```
...
var schema = Joi.object(***REMOVED***
    ...
    value: Joi.string(),
***REMOVED***).pattern(/firstname|lastname/, Joi.string().min(2));
```
...
var schema = Joi.object(***REMOVED***
    a: Joi.string()
***REMOVED***).pattern(/\w\d/, Joi.boolean());
```
...
object.validate(***REMOVED*** b: 5 ***REMOVED***, function (err, value) ***REMOVED*** ***REMOVED***);
```
...
var schema = Joi.object().keys(***REMOVED***
    ...
    ***REMOVED***,
    d: ***REMOVED***
        e: Joi.any()
    ***REMOVED***
***REMOVED***).assert('d.e', Joi.ref('a.c'), 'equal to a.c');
```
...
```javascript
var schema = Joi.object(***REMOVED*** a: Joi.any() ***REMOVED***).unknown();
```
...
```javascript
var schema = Joi.object().keys(***REMOVED*** a: ***REMOVED*** b: Joi.number() ***REMOVED***, c: ***REMOVED*** d: Joi.string() ***REMOVED*** ***REMOVED***);
...
```javascript
var schema = Joi.object().keys(***REMOVED*** a: ***REMOVED*** b: Joi.number().required() ***REMOVED***, c: ***REMOVED*** d: Joi.string().required() ***REMOVED*** ***REMOVED***);
...
schema.validate('12345', function (err, value) ***REMOVED*** ***REMOVED***);
```
...
schema.validate('abBc', function (err, value) ***REMOVED***
...
var schema = Joi.string().ip(***REMOVED***
  version: [
    'ipv4',
    'ipv6'
  ],
...
```javascript
var alt = Joi.alternatives().try(Joi.number(), Joi.string());
alt.validate('a', function (err, value) ***REMOVED*** ***REMOVED***);
```
...
```javascript
var schema = ***REMOVED***
    a: Joi.alternatives().when('b', ***REMOVED*** is: 5, then: Joi.string(), otherwise: Joi.number() ***REMOVED***),
    b: Joi.any()
***REMOVED***;
```
...
```javascript
var schema = ***REMOVED***
    a: Joi.when('b', ***REMOVED*** is: true, then: Joi.required() ***REMOVED***),
    b: Joi.boolean()
***REMOVED***;
```
...
Joi.validate(***REMOVED*** a: 5, b: ***REMOVED*** c: 5 ***REMOVED*** ***REMOVED***, schema, ***REMOVED*** context: ***REMOVED*** x: 5 ***REMOVED*** ***REMOVED***, function (err, value) ***REMOVED******REMOVED***);
```
