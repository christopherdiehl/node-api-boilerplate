...
Asynchronous
```
bcrypt.hash("bacon", null, null, function(err, hash) ***REMOVED***
	// Store hash in your password DB.
***REMOVED***);

// Load hash from your password DB.
bcrypt.compare("bacon", hash, function(err, res) ***REMOVED***
    // res == true
***REMOVED***);
bcrypt.compare("veggies", hash, function(err, res) ***REMOVED***
    // res = false
***REMOVED***);
```
