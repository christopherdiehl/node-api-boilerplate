...
describe('invalid expiration', function() ***REMOVED***

  it('should fail with string', function (done) ***REMOVED***
    ...
    jwt.verify(broken_token, '123', function (err, decoded) ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should fail with 0', function (done) ***REMOVED***
    ...
    jwt.verify(broken_token, '123', function (err) ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should fail with false', function (done) ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should fail with true', function (done) ***REMOVED***
  ...
  ***REMOVED***);
  ...
  it('should fail with object', function (done) ***REMOVED***
