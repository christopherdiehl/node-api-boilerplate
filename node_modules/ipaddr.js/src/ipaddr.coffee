...
ipv6Part = "(?:[0-9a-f]+::?)+"
ipv6Regexes =
  native:       new RegExp "^(::)?(#***REMOVED***ipv6Part***REMOVED***)?([0-9a-f]+)?(::)?$", 'i'
  transitional: new RegExp "^((?:#***REMOVED***ipv6Part***REMOVED***)|(?:::)(?:#***REMOVED***ipv6Part***REMOVED***)?)" +
                           "#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***\\.#***REMOVED***ipv4Part***REMOVED***$", 'i'
