...
***REMOVED******REMOVED***% note class="important" %***REMOVED******REMOVED***
Windows already contains the SSPI API used for Kerberos authentication. However you will need to install a full compiler tool chain using visual studio C++ to correctly install the kerberos extension.
***REMOVED******REMOVED***% /note %***REMOVED******REMOVED***
...
```js
var insertDocuments = function(db, callback) ***REMOVED***
...
```js
var updateDocument = function(db, callback) ***REMOVED***
  // Get the documents collection
  var collection = db.collection('documents');
...
```js
var deleteDocument = function(db, callback) ***REMOVED***
  // Get the documents collection
  var collection = db.collection('documents');
  // Insert some documents
...
MongoClient.connect(url, function(err, db) ***REMOVED***
  ...
  insertDocuments(db, function() ***REMOVED***
    updateDocument(db, function() ***REMOVED***
      deleteDocument(db, function() ***REMOVED***
        db.close();
      ***REMOVED***);
    ***REMOVED***);
  ***REMOVED***);
...
```js
var findDocuments = function(db, callback) ***REMOVED***
  // Get the documents collection
  var collection = db.collection('documents');
  // Find some documents
