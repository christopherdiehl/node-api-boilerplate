...
`***REMOVED*** signed: true ***REMOVED***` can optionally be passed as the second parameter _options_. In this case, a signature cookie (a cookie of same name ending with the `.sig` suffix appended) is fetched. If no such cookie exists, nothing is returned.
...
server = http.createServer( function( req, res ) ***REMOVED***
  var cookies = new Cookies( req, res, ***REMOVED*** "keys": keys ***REMOVED*** )
    , unsigned, signed, tampered

  if ( req.url == "/set" ) ***REMOVED***
    cookies
      // set a regular cookie
      .set( "unsigned", "foo", ***REMOVED*** httpOnly: false ***REMOVED*** )

      // set a signed cookie
      .set( "signed", "bar", ***REMOVED*** signed: true ***REMOVED*** )

      // mimic a signed cookie, but with a bogus signature
      .set( "tampered", "baz" )
      .set( "tampered.sig", "bogus" )

    res.writeHead( 302, ***REMOVED*** "Location": "/" ***REMOVED*** )
    return res.end( "Now let's check." )
  ***REMOVED***

  unsigned = cookies.get( "unsigned" )
  signed = cookies.get( "signed", ***REMOVED*** signed: true ***REMOVED*** )
  tampered = cookies.get( "tampered", ***REMOVED*** signed: true ***REMOVED*** )
