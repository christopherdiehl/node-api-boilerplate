...
var default = ***REMOVED***url : "www.github.com", port : "8000", debug : true***REMOVED***;

var config = Hoek.applyToDefaults(default, ***REMOVED***port : "3000", admin : true***REMOVED***);
...
var source = ***REMOVED***a: 0, c: 5***REMOVED***;
var source2 = ***REMOVED***a: null, c: 5***REMOVED***;

Hoek.merge(target, source);         // results in ***REMOVED***a: 0, b: 2, c: 5***REMOVED***
Hoek.merge(target, source2);        // results in ***REMOVED***a: null, b: 2, c: 5***REMOVED***
Hoek.merge(target, source2, false); // results in ***REMOVED***a: 1, b: 2, c: 5***REMOVED***
...
var defaults = ***REMOVED*** host: "localhost", port: 8000 ***REMOVED***;
var options = ***REMOVED*** port: 8080 ***REMOVED***;

var config = Hoek.applyToDefaults(defaults, options); // results in ***REMOVED*** host: "localhost", port: 8080 ***REMOVED***
```
...
var defaults = ***REMOVED*** host: "localhost", port: 8000 ***REMOVED***;
var options = ***REMOVED*** host: null, port: 8080 ***REMOVED***;

var config = Hoek.applyToDefaults(defaults, options, true); // results in ***REMOVED*** host: null, port: 8080 ***REMOVED***
```
...
var options = ***REMOVED*** server: ***REMOVED*** port: 8080 ***REMOVED*** ***REMOVED***;

var config = Hoek.applyToDefaultsWithShallow(defaults, options, ['server']); // results in ***REMOVED*** server: ***REMOVED*** port: 8080 ***REMOVED***, name: 'example' ***REMOVED***
```
...
```javascript
Hoek.deepEqual(***REMOVED*** a: [1, 2], b: 'string', c: ***REMOVED*** d: true ***REMOVED*** ***REMOVED***, ***REMOVED*** a: [1, 2], b: 'string', c: ***REMOVED*** d: true ***REMOVED*** ***REMOVED***); //results in true
Hoek.deepEqual(Object.create(null), ***REMOVED******REMOVED***, ***REMOVED*** prototype: false ***REMOVED***); //results in true
Hoek.deepEqual(Object.create(null), ***REMOVED******REMOVED***); //results in false
```
...
array = [***REMOVED***id: 1***REMOVED***, ***REMOVED***id: 1***REMOVED***, ***REMOVED***id: 2***REMOVED***];

newArray = Hoek.unique(array, "id");  // results in [***REMOVED***id: 1***REMOVED***, ***REMOVED***id: 2***REMOVED***]
```
...
var array = [1,2,3];
var newObject = Hoek.mapToObject(array);   // results in [***REMOVED***"1": true***REMOVED***, ***REMOVED***"2": true***REMOVED***, ***REMOVED***"3": true***REMOVED***]

array = [***REMOVED***id: 1***REMOVED***, ***REMOVED***id: 2***REMOVED***];
newObject = Hoek.mapToObject(array, "id"); // results in [***REMOVED***"id": 1***REMOVED***, ***REMOVED***"id": 2***REMOVED***]
```
...
```javascript
Hoek.contain('aaa', 'a', ***REMOVED*** only: true ***REMOVED***);							// true
Hoek.contain([***REMOVED*** a: 1 ***REMOVED***], [***REMOVED*** a: 1 ***REMOVED***], ***REMOVED*** deep: true ***REMOVED***);				// true
Hoek.contain([1, 2, 2], [1, 2], ***REMOVED*** once: true ***REMOVED***);					// false
Hoek.contain(***REMOVED*** a: 1, b: 2, c: 3 ***REMOVED***, ***REMOVED*** a: 1, d: 4 ***REMOVED***, ***REMOVED*** part: true ***REMOVED***); // true
```
...
var chain = 'a.b.c';
var obj = ***REMOVED***a : ***REMOVED***b : ***REMOVED*** c : 1***REMOVED******REMOVED******REMOVED***;

Hoek.reach(obj, chain); // returns 1

var chain = 'a.b.-1';
var obj = ***REMOVED***a : ***REMOVED***b : [2,3,6]***REMOVED******REMOVED***;
...
Replaces string parameters (`***REMOVED***name***REMOVED***`) with their corresponding object key values by applying the
(`reach()`)[#reachobj-chain-options] method where:

- `obj` - the context object used for key lookup.
- `template` - a string containing `***REMOVED******REMOVED***` parameters.
...
Hoek.reachTemplate(obj, '1+***REMOVED***a.b.c***REMOVED***=2'); // returns '1+1=2'
```
...
```javascript
var shallow = Hoek.shallow(***REMOVED*** a: ***REMOVED*** b: 1 ***REMOVED*** ***REMOVED***);
```
...
var a = Hoek.escapeRegex('4^f$s.4*5+-_?%=#!:@|~\\/`"(>)[<]d***REMOVED******REMOVED***s,');  // returns 4\^f\$s\.4\*5\+\-_\?%\=#\!\:@\|~\\\/`"\(>\)\[<\]d\***REMOVED***\***REMOVED***s\,
```
...
```javascript
var result = Hoek.uniqueFilename('./test/modules', 'txt'); // results in "full/path/test/modules/***REMOVED***random***REMOVED***.txt"
```
