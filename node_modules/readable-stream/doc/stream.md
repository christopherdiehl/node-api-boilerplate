  ...
  ***REMOVED***);
  ...
  req.on('end', () => ***REMOVED***
    ...
    ***REMOVED*** catch (er) ***REMOVED***
      // uh oh!  bad json!
      res.statusCode = 400;
      return res.end(`error: $***REMOVED***er.message***REMOVED***`);
    ***REMOVED***
...
// $ curl localhost:1337 -d '***REMOVED******REMOVED***'
// object
...
function writeOneMillionTimes(writer, data, encoding, callback) ***REMOVED***
  let i = 1000000;
  write();
...
for (var i = 0; i < 100; i ++) ***REMOVED***
  writer.write('hello, #$***REMOVED***i***REMOVED***!\n');
***REMOVED***
writer.end('This is the end\n');
writer.on('finish', () => ***REMOVED***
...
* `src` ***REMOVED***stream.Readable***REMOVED*** source stream that is piping to this writable
...
* `src` ***REMOVED***[Readable][] Stream***REMOVED*** The source stream that
...
* `chunk` ***REMOVED***String|Buffer|any***REMOVED*** Optional data to write. For streams not operating
...
* `encoding` ***REMOVED***String***REMOVED*** The encoding, if `chunk` is a String
* `callback` ***REMOVED***Function***REMOVED*** Optional callback for when the stream is finished
...
* `encoding` ***REMOVED***String***REMOVED*** The new default encoding
* Return: `this`
...
* `chunk` ***REMOVED***String|Buffer***REMOVED*** The data to write
* `encoding` ***REMOVED***String***REMOVED*** The encoding, if `chunk` is a String
* `callback` ***REMOVED***Function***REMOVED*** Callback for when this chunk of data is flushed
* Returns: ***REMOVED***Boolean***REMOVED*** `false` if the stream wishes for the calling code to
...
* `chunk` ***REMOVED***Buffer|String|any***REMOVED*** The chunk of data. For streams that are not
...
* `destination` ***REMOVED***stream.Writable***REMOVED*** The destination for writing data
* `options` ***REMOVED***Object***REMOVED*** Pipe options
  * `end` ***REMOVED***Boolean***REMOVED*** End the writer when the reader ends. Defaults to `true`.
...
```js
reader.pipe(writer, ***REMOVED*** end: false ***REMOVED***);
reader.on('end', () => ***REMOVED***
  writer.end('Goodbye\n');
***REMOVED***);
```
...
* `size` ***REMOVED***Number***REMOVED*** Optional argument to specify how much data to read.
...
* `encoding` ***REMOVED***String***REMOVED*** The encoding to use.
* Return: `this`
...
* `destination` ***REMOVED***stream.Writable***REMOVED*** Optional specific stream to unpipe
...
* `chunk` ***REMOVED***Buffer|String***REMOVED*** Chunk of data to unshift onto the read queue
...
* `stream` ***REMOVED***Stream***REMOVED*** An "old style" readable stream
...
class MyWritable extends Writable ***REMOVED***
...
const myWritable = new Writable(***REMOVED***
...
* `options` ***REMOVED***Object***REMOVED***
  * `highWaterMark` ***REMOVED***Number***REMOVED*** Buffer level when
    [`stream.write()`][stream-write] starts returning `false`. Defaults to
    `16384` (16kb), or `16` for `objectMode` streams.
  * `decodeStrings` ***REMOVED***Boolean***REMOVED*** Whether or not to decode strings into
    Buffers before passing them to [`stream._write()`][stream-_write].
    Defaults to `true`
  * `objectMode` ***REMOVED***Boolean***REMOVED*** Whether or not the
  ...
  * `write` ***REMOVED***Function***REMOVED*** Implementation for the
    [`stream._write()`][stream-_write] method.
  * `writev` ***REMOVED***Function***REMOVED*** Implementation for the
...
function MyWritable(options) ***REMOVED***
...
const myWritable = new Writable(***REMOVED***
  write(chunk, encoding, callback) ***REMOVED***
    // ...
  ***REMOVED***,
  writev(chunks, callback) ***REMOVED***
    // ...
  ***REMOVED***
***REMOVED***);
```
...
* `chunk` ***REMOVED***Buffer|String***REMOVED*** The chunk to be written. Will **always**
  be a buffer unless the `decodeStrings` option was set to `false`.
* `encoding` ***REMOVED***String***REMOVED*** If the chunk is a string, then `encoding` is the
  character encoding of that string. If chunk is a `Buffer`, or if the
  stream is operating in object mode, `encoding` may be ignored.
* `callback` ***REMOVED***Function***REMOVED*** Call this function (optionally with an error
...
* `chunks` ***REMOVED***Array***REMOVED*** The chunks to be written. Each chunk has following
  format: `***REMOVED*** chunk: ..., encoding: ... ***REMOVED***`.
* `callback` ***REMOVED***Function***REMOVED*** A callback function (optionally with an error
...
const myWritable = new Writable(***REMOVED***
  write(chunk, encoding, callback) ***REMOVED***
    if (chunk.toString().indexOf('a') >= 0) ***REMOVED***
...
class MyWritable extends Writable ***REMOVED***
  ...
  ***REMOVED***
  ...
  _write(chunk, encoding, callback) ***REMOVED***
    if (chunk.toString().indexOf('a') >= 0) ***REMOVED***
      callback(new Error('chunk is invalid'));
    ***REMOVED*** else ***REMOVED***
      callback();
...
* `options` ***REMOVED***Object***REMOVED***
  * `highWaterMark` ***REMOVED***Number***REMOVED*** The maximum number of bytes to store in
    the internal buffer before ceasing to read from the underlying
    resource. Defaults to `16384` (16kb), or `16` for `objectMode` streams
  * `encoding` ***REMOVED***String***REMOVED*** If specified, then buffers will be decoded to
    strings using the specified encoding. Defaults to `null`
  * `objectMode` ***REMOVED***Boolean***REMOVED*** Whether this stream should behave
    as a stream of objects. Meaning that [`stream.read(n)`][stream-read] returns
    a single value instead of a Buffer of size n. Defaults to `false`
  * `read` ***REMOVED***Function***REMOVED*** Implementation for the [`stream._read()`][stream-_read]
    method.
...
class MyReadable extends Readable ***REMOVED***
  constructor(options) ***REMOVED***
...
function MyReadable(options) ***REMOVED***
...
const myReadable = new Readable(***REMOVED***
  read(size) ***REMOVED***
    // ...
  ***REMOVED***
***REMOVED***);
...
* `size` ***REMOVED***Number***REMOVED*** Number of bytes to read asynchronously
...
* `chunk` ***REMOVED***Buffer|Null|String***REMOVED*** Chunk of data to push into the read queue
* `encoding` ***REMOVED***String***REMOVED*** Encoding of String chunks.  Must be a valid
  Buffer encoding, such as `'utf8'` or `'ascii'`
* Returns ***REMOVED***Boolean***REMOVED*** `true` if additional chunks of data may continued to be
...
class SourceWrapper extends Readable ***REMOVED***
  constructor(options) ***REMOVED***
    super(options);
    ...
    this._source.ondata = (chunk) => ***REMOVED***
...
const myReadable = new Readable(***REMOVED***
  read(size) ***REMOVED***
    if (checkSomeErrorCondition()) ***REMOVED***
...
class Counter extends Readable ***REMOVED***
...
* `options` ***REMOVED***Object***REMOVED*** Passed to both Writable and Readable
  constructors. Also has the following fields:
  * `allowHalfOpen` ***REMOVED***Boolean***REMOVED*** Defaults to `true`. If set to `false`, then
    the stream will automatically end the readable side when the
    writable side ends and vice versa.
  * `readableObjectMode` ***REMOVED***Boolean***REMOVED*** Defaults to `false`. Sets `objectMode`
    for readable side of the stream. Has no effect if `objectMode`
    is `true`.
  * `writableObjectMode` ***REMOVED***Boolean***REMOVED*** Defaults to `false`. Sets `objectMode`
...
class MyDuplex extends Duplex ***REMOVED***
  constructor(options) ***REMOVED***
    super(options);
  ***REMOVED***
***REMOVED***
...
function MyDuplex(options) ***REMOVED***
...
const myDuplex = new Duplex(***REMOVED***
  read(size) ***REMOVED***
    // ...
  ***REMOVED***,
  write(chunk, encoding, callback) ***REMOVED***
...
class MyDuplex extends Duplex ***REMOVED***
  constructor(source, options) ***REMOVED***
    super(options);
    this[kSource] = source;
  ***REMOVED***
  ...
  ***REMOVED***
  ...
  _read(size) ***REMOVED***
    this[kSource].fetchSomeData(size, (data, encoding) => ***REMOVED***
...
const myTransform = new Transform(***REMOVED***
...
* `options` ***REMOVED***Object***REMOVED*** Passed to both Writable and Readable
  constructors. Also has the following fields:
  * `transform` ***REMOVED***Function***REMOVED*** Implementation for the
    [`stream._transform()`][stream-_transform] method.
  * `flush` ***REMOVED***Function***REMOVED*** Implementation for the [`stream._flush()`][stream-_flush]
    method.
...
class MyTransform extends Transform ***REMOVED***
  constructor(options) ***REMOVED***
    super(options);
  ***REMOVED***
***REMOVED***
...
function MyTransform(options) ***REMOVED***
...
* `chunk` ***REMOVED***Buffer|String***REMOVED*** The chunk to be transformed. Will **always**
  be a buffer unless the `decodeStrings` option was set to `false`.
* `encoding` ***REMOVED***String***REMOVED*** If the chunk is a string, then this is the
...
```js
transform.prototype._transform = function (data, encoding, callback) ***REMOVED***
  this.push(data);
  callback();
***REMOVED***;
...
```js
// WARNING!  BROKEN!
net.createServer((socket) => ***REMOVED***
