...
eyes.inspector = function (options) ***REMOVED***
    var that = this;
    return function (obj, label, opts) ***REMOVED***
        return that.inspect.call(that, obj, label,
            merge(options || ***REMOVED******REMOVED***, opts || ***REMOVED******REMOVED***));
    ***REMOVED***;
***REMOVED***;

// If we have a `stream` defined, use it to print a styled string,
// if not, we just return the stringified object.
eyes.inspect = function (obj, label, options) ***REMOVED***
    options = merge(this.defaults, options || ***REMOVED******REMOVED***);
...
// length manually.
eyes.print = function (str, label, options) ***REMOVED***
    for (var c = 0, i = 0; i < str.length; i++) ***REMOVED***
        if (str.charAt(i) === '\033') ***REMOVED*** i += 4 ***REMOVED*** // `4` because '\033[25m'.length + 1 == 5
        else if (c === options.maxLength) ***REMOVED***
           str = str.slice(0, i - 1) + '…';
           break;
        ***REMOVED*** else ***REMOVED*** c++ ***REMOVED***
    ***REMOVED***
...
// styles.
eyes.stylize = function (str, style, styles) ***REMOVED***
    var codes = ***REMOVED***
        'bold'      : [1,  22],
        'underline' : [4,  24],
        'inverse'   : [7,  27],
...
// stringify().
function stringify(obj, options) ***REMOVED***
    var that = this, stylize = function (str, style) ***REMOVED***
        return eyes.stylize(str, options.styles[style], options.styles)
    ***REMOVED***, index, result;

    if ((index = stack.indexOf(obj)) !== -1) ***REMOVED***
        return stylize(new(Array)(stack.length - index + 1).join('.'), 'special');
    ***REMOVED***
    stack.push(obj);

    result = (function (obj) ***REMOVED***
        switch (typeOf(obj)) ***REMOVED***
...
function stringifyString (str, options) ***REMOVED***
    return str.replace(/\\/g, '\\\\')
              .replace(/\n/g, '\\n')
              .replace(/[\u0001-\u001F]/g, function (match) ***REMOVED***
...
// in the array.
function stringifyArray(ary, options, level) ***REMOVED***
    var out = [];
    var pretty = options.pretty && (ary.length > 4 || ary.some(function (o) ***REMOVED***
        return (o !== null && typeof(o) === 'object' && Object.keys(o).length > 0) ||
               (Array.isArray(o) && o.length > 0);
    ***REMOVED***));
    var ws = pretty ? '\n' + new(Array)(level * 4 + 1).join(' ') : ' ';

    for (var i = 0; i < ary.length; i++) ***REMOVED***
        out.push(stringify(ary[i], options));
    ***REMOVED***

    if (out.length === 0) ***REMOVED***
        return '[]';
    ***REMOVED*** else ***REMOVED***
        return '[' + ws
                   + out.join(',' + (pretty ? ws : ' '))
...
// A better `typeof`
function typeOf(value) ***REMOVED***
    var s = typeof(value),
        types = [Object, Array, String, RegExp, Number, Function, Boolean, Date];

    if (s === 'object' || s === 'function') ***REMOVED***
        if (value) ***REMOVED***
            types.forEach(function (t) ***REMOVED***
                if (value instanceof t) ***REMOVED*** s = t.name.toLowerCase() ***REMOVED***
            ***REMOVED***);
        ***REMOVED*** else ***REMOVED*** s = 'null' ***REMOVED***
    ***REMOVED***
    return s;
***REMOVED***

function merge(/* variable args */) ***REMOVED***
    var objs = Array.prototype.slice.call(arguments);
    var target = ***REMOVED******REMOVED***;

    objs.forEach(function (o) ***REMOVED***
        Object.keys(o).forEach(function (k) ***REMOVED***
            if (k === 'styles') ***REMOVED***
                if (! o.styles) ***REMOVED***
                    target.styles = false;
                ***REMOVED*** else ***REMOVED***
                    target.styles = ***REMOVED******REMOVED***
                    for (var s in o.styles) ***REMOVED***
