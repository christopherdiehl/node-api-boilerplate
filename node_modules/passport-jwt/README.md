...
passport.use(new JwtStrategy(opts, function(jwt_payload, done) ***REMOVED***
    User.findOne(***REMOVED***id: jwt_payload.sub***REMOVED***, function(err, user) ***REMOVED***
        if (err) ***REMOVED***
...
```
var cookieExtractor = function(req) ***REMOVED***
    var token = null;
    if (req && req.cookies)
    ***REMOVED***
...
```js
app.post('/profile', passport.authenticate('jwt', ***REMOVED*** session: false***REMOVED***),
...
var JwtStrategy = require('passport-jwt').Strategy,
    ExtractJwt = require('passport-jwt').ExtractJwt;
var opts = ***REMOVED******REMOVED***
opts.jwtFromRequest = ExtractJwt.versionOneCompatibility(***REMOVED*** tokenBodyField = "MY_CUSTOM_BODY_FIELD" ***REMOVED***);
