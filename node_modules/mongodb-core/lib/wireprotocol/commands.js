...
var Insert = function(requestId, ismaster, bson, ns, documents, options) ***REMOVED***
...
// To Binary
Insert.prototype.toBin = function() ***REMOVED***
  ...
  for(var i = 0; i < this.documents.length; i++) ***REMOVED***
    var buffer = this.bson.serialize(this.documents[i], ***REMOVED***
    ...
    ***REMOVED***);
    ...
    if(buffer.length > this.ismaster.maxBsonObjectSize) ***REMOVED***
  ...
  ***REMOVED***
  ...
  if(totalLength > this.ismaster.maxMessageSizeBytes) ***REMOVED***
...
var Update = function(requestId, ismaster, bson, ns, update, options) ***REMOVED***
  // Basic options needed to be passed in
  if(ns == null) throw new MongoError("ns must be specified for query");
...
// To Binary
Update.prototype.toBin = function() ***REMOVED***
  // Contains all the buffers to be written
  var buffers = [];
  ...
  var selector = this.bson.serialize(this.q, ***REMOVED***
    checkKeys: this.checkKeys,
    serializeFunctions: this.serializeFunctions,
    ignoreUndefined: this.ignoreUndefined,
  ***REMOVED***);
  ...
  var update = this.bson.serialize(this.u, ***REMOVED***
    checkKeys: this.checkKeys,
    serializeFunctions: this.serializeFunctions,
    ignoreUndefined: this.ignoreUndefined,
  ***REMOVED***);
...
var Remove = function(requestId, ismaster, bson, ns, remove, options) ***REMOVED***
  // Basic options needed to be passed in
  if(ns == null) throw new MongoError("ns must be specified for query");
...
// To Binary
Remove.prototype.toBin = function() ***REMOVED***
  // Contains all the buffers to be written
  var buffers = [];
