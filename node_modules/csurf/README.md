...
var csrfProtection = csrf(***REMOVED*** cookie: true ***REMOVED***)
var parseForm = bodyParser.urlencoded(***REMOVED*** extended: false ***REMOVED***)
...
app.get('/form', csrfProtection, function(req, res) ***REMOVED***
  // pass the csrfToken to the view
  res.render('send', ***REMOVED*** csrfToken: req.csrfToken() ***REMOVED***)
***REMOVED***)

app.post('/process', parseForm, csrfProtection, function(req, res) ***REMOVED***
...
<form action="/process" method="POST">
  <input type="hidden" name="_csrf" value="***REMOVED******REMOVED***csrfToken***REMOVED******REMOVED***">
...
app.use(cookieParser())
app.use(csrf(***REMOVED*** cookie: true ***REMOVED***))

app.get('/form', function(req, res) ***REMOVED***
  // pass the csrfToken to the view
  res.render('send', ***REMOVED*** csrfToken: req.csrfToken() ***REMOVED***)
***REMOVED***)

app.post('/process', function(req, res) ***REMOVED***
  res.send('csrf was required to get here')
***REMOVED***)

function createApiRouter() ***REMOVED***
  var router = new express.Router()

  router.post('/getProfile', function(req, res) ***REMOVED***
