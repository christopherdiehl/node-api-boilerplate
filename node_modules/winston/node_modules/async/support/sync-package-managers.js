...
packageJson.jam = ***REMOVED***
  main: packageJson.main,
  include: INCLUDES,
  categories: ['Utilities']
***REMOVED***;

packageJson.spm = ***REMOVED***
  main: packageJson.main
***REMOVED***;

packageJson.volo = ***REMOVED***
  main: packageJson.main,
  ignore: IGNORES
***REMOVED***;

var bowerSpecific = ***REMOVED***
...
var bowerJson = _.merge(***REMOVED******REMOVED***, _.pick(packageJson, bowerInclude), bowerSpecific);
var componentJson = _.merge(***REMOVED******REMOVED***, _.pick(packageJson, componentInclude), componentSpecific);
